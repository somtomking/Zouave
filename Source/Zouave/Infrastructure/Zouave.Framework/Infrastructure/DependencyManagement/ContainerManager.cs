...
namespace Zouave.Framework.Infrastructure.DependencyManagement
{
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new ZouaveException("Unkown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (ZouaveException)
                {

                }
            }
            throw new ZouaveException("No contructor was found that had all the dependencies satisfied.");
        }
