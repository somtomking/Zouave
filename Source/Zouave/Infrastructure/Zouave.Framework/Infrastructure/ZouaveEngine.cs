...
namespace Zouave.Framework.Infrastructure
{
    public class ZouaveEngine:IEngine
    {
        ...
        protected virtual void RegisterDependencies(ZouaveConfig config)
        {
            ...
            builder.RegisterInstance(config).As<ZouaveConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(ZouaveConfig config)
        {
            //register dependencies
