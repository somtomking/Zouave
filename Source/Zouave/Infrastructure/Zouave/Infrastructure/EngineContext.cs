...
namespace Zouave.Infrastructure
{
    ...
    public class EngineContext
    {
        ...
        protected static IEngine CreateEngineInstance(ZouaveConfig config)
        {
        ...
        public static IEngine Initialize(bool forceRecreate)
        {
            ...
            {
                var config = ConfigurationManager.GetSection("ZouaveConfig") as ZouaveConfig;
