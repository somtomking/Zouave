...
namespace Zouave.Helper
{
    public static class PinyinHelper
    {
        ...
        #region 获取汉字的首字母
        private readonly static string[] strChineseCharList = 
            { 
                #region
         ...
         new string[][]
   {
    ...
    new string[]{"Zuo","做作坐左座昨凿琢撮佐笮酢唑祚胙怍阼柞乍侳咗岝岞挫捽柮椊砟秨稓筰糳繓苲莋葃葄蓙袏諎醋鈼鑿飵嘬阝"}
        ...
        #region  取自 http://www.newlifex.com/showtopic-95.aspx
        #region
        ...
        /// <returns></returns>
        public static string Convert(string text, PinyinConvertType type = PinyinConvertType.First)
        {
            string result = string.Empty;
            switch (type)
            {
                case PinyinConvertType.First:
                    result = GetFirst(text);
                    break;
                case PinyinConvertType.All:
                    result = Get(text);
                    break;
                default:
                    result = text;
    ...
    public enum PinyinConvertType : int
    {
        /// <summary>
        /// 拼音首字母
        /// </summary>
